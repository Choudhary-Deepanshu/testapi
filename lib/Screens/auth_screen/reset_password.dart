...
import 'package:testapi/Screens/auth_screen/verify_otp_screen.dart';
                    ...
                    child: CustomButton(
                        ...
                        onPressed: () async{
                          ...
                          if (newPassCtrl.text.trim() ==
                              confirmNewPassCtrl.text.trim()&&newPassCtrl.text.isNotEmpty) {
                              var res=await apiContainer.resetPassword(token: pref.getString("authToken").toString(), passsword: newPassCtrl.text.trim(), cpassword: confirmNewPassCtrl.text.trim());
                              if (res['success'] == true) {
